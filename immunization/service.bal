...
service / on new fhirr4:Listener(9090, apiConfig) {
    ...
    isolated resource function get fhir/r4/Immunization/[string id](r4:FHIRContext fhirContext) returns string {
        return "Immunization";
    }
    ...
    isolated resource function get fhir/r4/Immunization(r4:FHIRContext fhirContext) returns string{
        return "Immunization";
    }
