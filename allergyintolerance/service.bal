...
service / on new fhirr4:Listener(9090, apiConfig) {
    ...
    isolated resource function get .(r4:FHIRContext fhirContext) returns
        AllergyIntolerance|r4:OperationOutcome|r4:FHIRError {
        AllergyIntolerance allergyIntolerance = {
        resourceType: "AllergyIntolerance",
        id: "1",
        text: {
    ...
    isolated resource function post .(r4:FHIRContext fhirContext, AllergyIntolerance procedure) returns AllergyIntolerance|r4:OperationOutcome|r4:FHIRError {
        return r4:createFHIRError("Not implemented", r4:ERROR, r4:INFORMATIONAL, httpStatusCode = http:STATUS_NOT_IMPLEMENTED);
    }
