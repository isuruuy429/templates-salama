...
service / on new fhirr4:Listener(9090, apiConfig) {
    ...
    isolated resource function get .(r4:FHIRContext fhirContext) returns CarePlan|r4:OperationOutcome|r4:FHIRError {
        CarePlan carePlan = {
            subject: {
                reference: "Patient/1",
                display: "Peter James Chalmers"
    ...
    isolated resource function post .(r4:FHIRContext fhirContext, CarePlan procedure) returns CarePlan|r4:OperationOutcome|r4:FHIRError {
        return r4:createFHIRError("Not implemented", r4:ERROR, r4:INFORMATIONAL, httpStatusCode = http:STATUS_NOT_IMPLEMENTED);
    }
