...
service / on new fhirr4:Listener(9090, apiConfig) {
    ...
    isolated resource function get [string id](r4:FHIRContext fhirContext) returns Observation {
    ...
    isolated resource function get .(r4:FHIRContext fhirContext) returns Observation {
        Observation observation = {
            resourceType: "Observation",
            code: {}, subject: {}, category: [], status: "preliminary"};
        return observation;
    ...
    isolated resource function post .(r4:FHIRContext fhirContext, Observation procedure) returns Observation|r4:OperationOutcome|r4:FHIRError {
        return r4:createFHIRError("Not implemented", r4:ERROR, r4:INFORMATIONAL, httpStatusCode = http:STATUS_NOT_IMPLEMENTED);
    }
