...
service / on new fhirr4:Listener(9090, apiConfig) {
    ...
    isolated resource function get fhir/r4/Procedure/[string id](r4:FHIRContext fhirContext) returns string|r4:OperationOutcome|r4:FHIRError {
        return "procedure";
    }
    ...
    isolated resource function get fhir/r4/Procedure(r4:FHIRContext fhirContext) returns string {
        return "procedure";
    }
