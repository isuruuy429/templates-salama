...
service / on new fhirr4:Listener(9090, apiConfig) {
    ...
    isolated resource function get .(r4:FHIRContext fhirContext) returns MedicationRequest {
        MedicationRequest medicationRequest = {
            requester: {},
            medicationReference: {},
            subject: {},
    ...
    isolated resource function post .(r4:FHIRContext fhirContext, MedicationRequest procedure) returns MedicationRequest|r4:OperationOutcome|r4:FHIRError {
        return r4:createFHIRError("Not implemented", r4:ERROR, r4:INFORMATIONAL, httpStatusCode = http:STATUS_NOT_IMPLEMENTED);
    }
