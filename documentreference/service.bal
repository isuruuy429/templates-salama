...
service / on new fhirr4:Listener(9090, apiConfig) {
    ...
    isolated resource function get fhir/r4/DocumentReference/[string id](r4:FHIRContext fhirContext) returns string {
    ...
    isolated resource function get fhir/r4/DocumentReference(r4:FHIRContext fhirContext) returns string {
        return "DocumentReference";
    }
