...
service / on new fhirr4:Listener(9090, apiConfig) {
    ...
    isolated resource function get [string id](r4:FHIRContext fhirContext) returns string {
    ...
    isolated resource function get .(r4:FHIRContext fhirContext) returns string {
        return "DocumentReference";
    }

    // Create a new resource.
    isolated resource function post .(r4:FHIRContext fhirContext, DocumentReference procedure) returns DocumentReference|r4:OperationOutcome|r4:FHIRError {
        return r4:createFHIRError("Not implemented", r4:ERROR, r4:INFORMATIONAL, httpStatusCode = http:STATUS_NOT_IMPLEMENTED);
    }
